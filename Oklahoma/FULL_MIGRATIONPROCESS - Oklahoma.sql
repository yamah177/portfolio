...
-- creates tables as existing in legacy db. creates procs if not there and runs as far as it can and gets a count or rows in each table. 
...
EXEC FILEVINE_META.DBO.USP_LOAD_STAGING_TO_IMPORT 
	@DEBUGFLAG = 0,
	@IMPORTSERVER = 'FilevineProductionImport',
	@LEGACYDB = '7831_Oklahoma_GL',
	@FVPRODUCTIONPREFIX = '_OklahomaLegalService_',
	@PEIDLIST = '', -- never used

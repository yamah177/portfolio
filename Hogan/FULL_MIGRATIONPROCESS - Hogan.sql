...
EXECUTE FILEVINE_META.PT1.FULL_MIGRATIONPROCESS 
	@DEBUGFLAG = 0, -- leave at 0
	@LEGACYDBTYPE = 'Firm Central', -- see helpful queries
	@LEGACYDB = '990000153_Hogan_T2', -- For go live, put the GL db
	@PREVIOUSDB = '990000153_Hogan_R1', -- leave blank unless going live or moving to a refreshed database.
	@ORGID = 990000153, 
	@SCHEMANAME = 'dbo', -- time matters uses 1ntmuid, but normally it's dbo
	@FVPRODUCTIONPREFIX = '_HoganT5_', --  
	@FVPREVIOUSPREFIX = '_HoganT4_', -- not needed for a first test
	@IMPORTDATABASENAME = 'FilevineStaging2Import', -- have the 2 or not
	@EXECUTIONDB = 'Filevine_META', -- never changed.
	@USEGENERICTEMPLATE = 0,
	@TIMEZONE = 'central'; --,
	--@REFRESHPROCS = 1; -- optional and loaded gun. set to 1, then bad deal, overwrite with empty. 

EXEC FILEVINE_META.QA.USP_VERIFY_IMPORT_LOAD 
	@STAGINGIMPORT = 1,
	@REVIEWDATA = 1,[lntmuid].[prop personal injury]

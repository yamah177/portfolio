...
EXECUTE FILEVINE_META.PT1.FULL_MIGRATIONPROCESS 
	...
	@LEGACYDBTYPE = 'practicemaster', -- see helpful queries
	@LEGACYDB = '990000147_Dorato_ST1', -- For go live, put the GL db
	@PREVIOUSDB = NULL, -- leave blank unless going live or moving to a refreshed database.
	@ORGID = 990000147, 
	@SCHEMANAME = 'dbo', -- time matters uses 1ntmuid, but normally it's dbo
	@FVPRODUCTIONPREFIX = '_Dorato_T2_', --  
	@FVPREVIOUSPREFIX = '_Dorato_T1_', -- not needed for a first test

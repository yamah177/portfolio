...
EXECUTE FILEVINE_META.PT1.FULL_MIGRATIONPROCESS 
	...
	@LEGACYDBTYPE = 'Documents', -- see helpful queries
	@LEGACYDB = '497_Rosette', -- For go live, put the GL db
	...
	@FVPRODUCTIONPREFIX = '_Rosette_T2_', --  
	@FVPREVIOUSPREFIX = '_497_Rosette_T1_', -- not needed for a first test
